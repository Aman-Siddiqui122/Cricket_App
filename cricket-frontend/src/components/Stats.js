...
const StatsModal = ({ player, matchId, teamId, onClose }) => {
  ...
  const submitStats = async (e) => {
    ...
    try {
      await api.post(`/stats/add?match_id=${matchId}`, {
        ...
        team_id: teamId,
        ...formData,
        overs_bowled: parseFloat(formData.overs_bowled),
      });
          ...
          <div className="stats-body">
            <form onSubmit={submitStats}>
              ...
              >
                ...
                {loading ? "Saving Stats..." : "Save Player Stats"}
              </button>
            </form>
          </div>
        </div>
